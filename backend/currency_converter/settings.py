...
INSTALLED_APPS = [
    ...
    'converter',
    'corsheaders',
    # Ensure WhiteNoise is installed in requirements.txt if you want to use it
]
...
# Database
# Using the default SQLite database since you do not need an external DB.
# Note: SQLite data is volatile on Render free instances (it will be reset).
DATABASES = {
    'default': {
